...
class EnvironmentCreateView(CreateView):
    ...
    fields = ['name', 'project']
    template_name = 'form_dynamic.html'
    success_url = reverse_lazy('environment_create')
    extra_context = {
...
class FeatureFlagCreateView(CreateView):
    ...
    template_name = 'form_dynamic.html'
    success_url = reverse_lazy('feature_flag_create')
    extra_context = {
...
class RolloutRuleCreateView(CreateView):
    ...
    template_name = 'form_dynamic.html'
    success_url = reverse_lazy('rollout_rule_create')
    extra_context = {
...
class ToggleLogCreateView(CreateView):
    ...
    template_name = 'form_dynamic.html'
    success_url = reverse_lazy('toggle_log_create')
    extra_context = {
...
class ProjectDeleteView(DeleteView):
    model = Project
    template_name = 'featureFlags/project_confirm_delete.html'
    success_url = reverse_lazy('project_create')
    extra_context = {
...
class EnvironmentDeleteView(DeleteView):
    model = Environment
    template_name = 'featureFlags/environment_confirm_delete.html'
    success_url = reverse_lazy('environment_create')
    extra_context = {
        'titulo': 'Deletar Ambiente',
    }

class FeatureFlagDeleteView(DeleteView):
    model = FeatureFlag
    template_name = 'featureFlags/feature_flag_confirm_delete.html'
    success_url = reverse_lazy('feature_flag_create')
    extra_context = {
        'titulo': 'Deletar Feature Flag',
    }

class RolloutRuleDeleteView(DeleteView):
    model = RolloutRule
    template_name = 'featureFlags/rollout_rule_confirm_delete.html'
    success_url = reverse_lazy('rollout_rule_create')
    extra_context = {
        'titulo': 'Deletar Regra de Rollout',
    }

class ToggleLogDeleteView(DeleteView):
    model = ToggleLog
    template_name = 'featureFlags/toggle_log_confirm_delete.html'
    success_url = reverse_lazy('toggle_log_create')
    extra_context = {
        'titulo': 'Deletar Log de Alteração',
    }

class FlagSchedulerDeleteView(DeleteView):
    model = FlagScheduler
    template_name = 'featureFlags/flag_scheduler_confirm_delete.html'
    success_url = reverse_lazy('flag_scheduler_create')
    extra_context = {
        'titulo': 'Deletar Agendamento de Feature Flag',
    }
